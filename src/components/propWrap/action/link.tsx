...
const Link = (props) => {
  ...
  const handleSave = () => {
    ...
    selectedBlock.fields.pathways = selectedOptionIds
  ...
  const onSearch = ({ state }) => {
    ...
    const url = `${siteConfig.airtableUrl}/${siteConfig.careBundleId}/Pathways${formulaText}`
